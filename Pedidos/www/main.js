...
/* harmony import */ var _guard_login_guard__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./guard/login.guard */ 4859);
...
const routes = [
    ...
    },
    {
        ...
        canLoad: [_guard_login_guard__WEBPACK_IMPORTED_MODULE_0__.LoginGuard]
    },
    {
        path: 'login',
    ...
    {
        path: 'producto',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_pages_tabs_producto_producto_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./pages/tabs/producto/producto.module */ 9079)).then(m => m.ProductoPageModule)
    },
    {
        path: 'carrito',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_pages_tabs_carrito_carrito_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./pages/tabs/carrito/carrito.module */ 4113)).then(m => m.CarritoPageModule)
    }
];
...
let LoginGuard = class LoginGuard {
  ...
  canLoad() {
    ...
    return (0,_Users_carlos_Desktop_Pedidos_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const hasSeenIntro = yield _capacitor_preferences__WEBPACK_IMPORTED_MODULE_1__.Preferences.get({
        key: INTRO_KEY
      });
...
LoginGuard = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.Injectable)({
  providedIn: 'root'
})], LoginGuard);
